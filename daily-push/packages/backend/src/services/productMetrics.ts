...
const PREMIUM_EVENTS = [
  ...
  { eventKey: 'career_market_landing_viewed', label: 'Career Market views' },
  ...
  { eventKey: 'market_upgrade_clicked', label: 'Market upgrade clicks' },
  { eventKey: 'checkout_started_from_market', label: 'Market checkout starts' },
  { eventKey: 'role_market_feedback_submitted', label: 'Market pilot feedback' },
